...
public class DealProposerConfigurationResolver  extends AgentConfigurationResolver {

	public DealProposerConfigurationResolver() {
		this.setItemLabel(" Books to suggest ");
